...
//    public static String Progress = "Progress";
    ...
    public static NetworkEvent threadsUpdated(Long threadId) {
        NetworkEvent event = new NetworkEvent(EventType.ThreadsUpdated);
...
//    }
    ...
    public static NetworkEvent messageInputAsr(Boolean definite, String message, boolean isOnline) {
        NetworkEvent event = new NetworkEvent(EventType.MessageInputAsr);
        Map<String, Object> params = new HashMap<>();
        params.put("definite", definite);
    ...
    public static NetworkEvent errorEvent(Message message, String errType, String errMsg) {
        Map<String, Object> params = new HashMap<>();
        params.put("type", errType);
        params.put("msg", errMsg);
        return new NetworkEvent(EventType.Error, null, message, null, params);
    }
